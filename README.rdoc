...
* Implemented and translated the "About" page
...
* To add in a new translation .yml file
  ...
  2. add in new translation path of .yml you created, follow example in starting on line 35 in layouts>application.html.erb
  3. copy paths from en.yml that you want to translate in view
  4. add in translation for each path to what is in view.  
